...
\lstinputlisting[title=Barbershop hint]{lessClassicProblem/barber1_0.py}
...
\lstinputlisting[title=Barbershop solution (customer)]{lessClassicProblem/barber1_1.py}
...
\lstinputlisting[title=Barbershop solution (barber)]{lessClassicProblem/barber1_2.py}
...
\lstinputlisting[title=FIFO barbershop hint]{lessClassicProblem/barber2_0.py}
...
{lessClassicProblem/barber3_0.py}
...
\lstinputlisting[title=Hilzer's barbershop solution (customer)] {lessClassicProblem/barber3_1.py}
...
\lstinputlisting[title=Hilzer's barbershop solution (barber)] {lessClassicProblem/barber3_2.py}
